...
const Home = () => {
  ...
  const bodyText = "Welcome to Bite Share, the wonderful website designed to help lower wasted food in India. This site is designed to combat the large number of food disposed of each day despite being perfectly edible. Hunger is a problem faced by several states in India, so we would like to help the needy people with food";
