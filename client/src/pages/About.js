  ...
  return (
    <div className="About">
      ...
      <div class="dropcap clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
        <p> Hello! Welcome to Bite Share, the wonderful website designed to help lower wasted food in India. This site is designed
        ...
        states in India, so we would like to help the needy people.</p>
